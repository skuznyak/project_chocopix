...
export const productsCatalog: Product[] = [
  ...
  },
  {
    ...
    slug: 'marshmallow-choc-banana',
    name: 'Маршмелоу з Ананасом',
    shortDescription: 'Банановий десерт з мʼяким шоколадним акцентом.',
    description:
      'Солодкий банановий профіль з шоколадною глибиною в мʼякій текстурі авторського маршмелоу. Добре працює як окремий десерт і як доповнення до гарячих напоїв.',
    composition: ['банан', 'шоколад', 'маршмелоу'],
    weight: 120,
    flavor: 'Choc Banana',
    price: 49,
    category: 'marshmallow',
    tags: ['маршмелоу', 'банан', 'шоколад'],
    popularity: 88,
    images: [
      { id: '1', src: '/products/marshmallow/Marshmallow_with_pineapple.webp', alt: 'Маршмелоу Choc Banana з бананово-шоколадним смаком' },
    ],
  ...
  },
  {
    ...
    slug: 'marshmallow-vanilla-bean-creme',
    name: 'Маршмелоу з Корицею',
    shortDescription: 'Ніжний ванільний кремовий профіль на щодень.',
    description:
      'Спокійний вершково-ванільний смак для тих, хто любить мʼякі десертні поєднання без зайвої різкості. Добре підходить до какао, кави та як універсальний подарунковий смак.',
    composition: ['ваніль', 'вершковий крем', 'маршмелоу'],
    weight: 120,
    flavor: 'Vanilla Bean Creme',
    price: 49,
    category: 'marshmallow',
    tags: ['маршмелоу', 'ваніль', 'для какао'],
    popularity: 87,
    images: [
      { id: '1', src: '/products/marshmallow/Marshmallow_with_cinnamon.webp', alt: 'Маршмелоу Vanilla Bean Creme з ніжним ванільним профілем' },
    ],
    reviewSummary: { rating: 4.7, reviewCount: 11 },
  },
  {
    id: 'marshmallow-dubai-chocolate-domes',
    slug: 'marshmallow-dubai-chocolate-domes',
    name: 'Мʼятно-Шоколадне Маршмелоу',
    shortDescription: 'Преміальний десертний акцент з фісташковим настроєм.',
    description:
      'Більш вишуканий marshmallow з шоколадним і десертно-фісташковим акцентом. Формат для особливого подарунка, святкової подачі або преміальної солодкої добірки.',
    composition: ['шоколад', 'фісташка', 'маршмелоу'],
    weight: 120,
    flavor: 'Dubai Chocolate Domes',
    price: 49,
    badge: 'hit',
    category: 'marshmallow',
    tags: ['маршмелоу', 'преміум', 'подарунок'],
    popularity: 99,
    images: [
      { id: '1', src: '/products/marshmallow/Mint_chocolate_marshmallow.webp', alt: 'Маршмелоу Dubai Chocolate Domes з преміальним шоколадним акцентом' },
      { id: '2', src: '/products/marshmallow/Mint_chocolate_marshmallow2.webp', alt: 'Маршмелоу Dubai Chocolate Domes для подарункової подачі' },
    ],
